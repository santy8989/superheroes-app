...
export class SuperheroService {
  ...
  private defaultHeroes: Superhero[] = [
    {
      ...
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5lo7PcxCCcEE1rbPIwFV37bTQoioBmNGhcg&s',
    },
    {
      id: 2,
      name: 'SUPERMAN',
    ...
    },
    {
      ...
      power: 'Money',
      image:
        'https://hips.hearstapps.com/hmg-prod/images/iron-man-nuevo-traje-1539168331.jpg?crop=1xw:0.27xh;center,top&resize=1200:*',
    },
  ];

  private heroesSubject: BehaviorSubject<Superhero[]> = new BehaviorSubject<
    Superhero[]
  >([]);
  ...
  private saveHeroesToLocalStorage(): void {
    localStorage.setItem(
      ...
      JSON.stringify(this.heroesSubject.value)
    );
  }
